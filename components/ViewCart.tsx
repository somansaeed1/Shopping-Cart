  ...
  return (
    ...
    {cart.length === 0 && (
      ...
      {cart.map((item:any, ind:number) => (
        <div key={ind} className="flex flex-col sm:flex-row items-start gap-4 bg-white p-4 rounded-xl border border-gray-100">
          ...
          <span 
          className="inline-block text-[10px] uppercase font-semibold bg-blue-50 text-blue-600 px-2 py-0.5 rounded mt-1">{item.category}
          </span>
          ...
          <div className="mt-2 flex items-center gap-2 text-xs text-gray-400">
              ...
              <ul className="pl-4">
                ...
                <li>{item.rating?.count} Reviews</li>
              </ul>
            </div>
        </div>
        </div>
